import * as ControlReleaseFinalityRecordApi from "./control-release-finality-record/index.js";
...
import * as ControlReleaseCertificateVerifyApi from "./control-release-certificate-verify/index.js";
import * as ControlReleaseCertificateApi from "./control-release-certificate/index.js";
import * as ControlReleaseArchiveVerifyApi from "./control-release-archive-verify/index.js";
...
export async function onRequest({ request, env }) {
  ...
  if (path === "/api/marketplace/control-release-record") {
    return ControlReleaseRecordApi.onRequest({ request, env });
  }


  if (path === "/api/marketplace/control-release-record-verify") {
    return ControlReleaseRecordVerifyApi.onRequest({ request, env });
  }
  ...
  if (path === "/api/marketplace/control-release-archive") {
    return ControlReleaseArchiveApi.onRequest({ request, env });
  }


  if (path === "/api/marketplace/control-release-archive-verify") {
    return ControlReleaseArchiveVerifyApi.onRequest({ request, env });
  }


  if (path === "/api/marketplace/control-release-certificate") {
    return ControlReleaseCertificateApi.onRequest({ request, env });
  }


  if (path === "/api/marketplace/control-release-certificate-verify") {
    return ControlReleaseCertificateVerifyApi.onRequest({ request, env });
  }


  if (path === "/api/marketplace/control-release-certificate-seal") {
    return ControlReleaseCertificateSealApi.onRequest({ request, env });
  }


  if (path === "/api/marketplace/control-release-certificate-seal-verify") {
    return ControlReleaseCertificateSealVerifyApi.onRequest({ request, env });
  }
  ...
  if (path === "/api/marketplace/control-release-finality-record") {
    return ControlReleaseFinalityRecordApi.onRequest({ request, env });
  }
